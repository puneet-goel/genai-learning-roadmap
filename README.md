...
This repository is not intended to be a definitive guide or expert resource. It is a structured collection of the questions I asked while learning, experimenting, and building projects in the GenAI ecosystem.
...
4. What is context and context window?
5. What are tokens?
6. What is tokenization?
7. How to control the randomness? - **Temperature Variable**
...
14. What is function and tool calling?
15. What is the difference between function calling and tool calling?
16. Is function call a subset of tool call? What all other types of tool calls exist?
17. Every tool call is a function call? If no, explain (web search, code execution, fixed vs dynamic schema input/output). - Function call is like a structured schema exposed to your model while tool call is like allowing your models to use external resources.
18. Controlling outputs generated by LLMs - structured vs unstructured output parsing
19. Famous models - Claude, Grok, GPT, Llama, DeepSeek, Gemini...
